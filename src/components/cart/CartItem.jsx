...
import { removeItemFromCart, increaseItemQuantity, decreaseItemQuantity } from "../../app/CartSlice.js";
...
const CartItem = ({ item: { id, title, text, img, color, shadow, price, cartQuantity } }) => {
  ...
  const increaseItem = () => {
    dispatch(increaseItemQuantity({ id, title, text, img, color, shadow, price, cartQuantity }))
  }

  const decreaseItem = () => {
    dispatch(decreaseItemQuantity({ id, title, text, img, color, shadow, price, cartQuantity }))
  }
      ...
      <div className="flex items-center justify-between w-full px-5">
        <div className="flex items-center gap-5">
          ...
          <div className="grid items-center gap-4">
            ...
            <div className="flex items-center justify-around w-full">
              <button type="button" className="bg-theme-cart rounded w-6 h-6 lg:w-5 lg:h-5 flex items-center justify-center active:scale-90" onClick={decreaseItem}>
              ...
              <button type="button" className="bg-theme-cart rounded w-6 h-6 lg:w-5 lg:h-5 flex items-center justify-center active:scale-90" onClick={increaseItem}>
        ...
        <div className="grid items-center gap-5">
          ...
          <div className="grid items-center justify-center">
            <button
              onClick={removeItem}
            type="button" className="bg-theme-cart rounded p-1 lg:p-0.5 grid items-center justify-items-center cursor-pointer" >
